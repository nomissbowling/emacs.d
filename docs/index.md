<h1 style="text-align:center;">GNU Emacs Configuration for Programming</h1>
...
検索結果を browse-url で表示させるコマンドです。

検索urlのフォーマとさえ分かれば、パッケージツールに頼らずともお好みのマイコマンドを作成できます。以下は、Webkio串刺し検索の例です。
