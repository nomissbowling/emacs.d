...
(leaf *user-mozc-tool
  ...
  (defun my:mozc-config-dialog ()
    ...
    (interactive)
    (async-shell-command "/usr/lib/mozc/mozc_tool --mode=config_dialog"))

  (defun my:mozc-dictionary-tool ()
    "Run the mozc-tool in the background."
    (interactive)
    (async-shell-command "/usr/lib/mozc/mozc_tool --mode=dictionary_tool"))

  (defun my:mozc-word-regist ()
    "Run the mozc-tool in the background."
    (interactive)
    (async-shell-command "/usr/lib/mozc/mozc_tool --mode=word_register_dialog"))

  (defun my:mozc-hand-writing ()
    "Run the mozc-tool in the background."
    (interactive)
    (async-shell-command "/usr/lib/mozc/mozc_tool --mode=hand_writing")))
